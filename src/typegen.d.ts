...
export type ConfigNames = 'euaaaio/ignores' | 'euaaaio/ignores/git' | 'euaaaio/javascript' | 'euaaaio/imports' | 'euaaaio/promise' | 'euaaaio/node' | 'euaaaio/de-morgan' | 'euaaaio/unicorn' | 'euaaaio/unicorn/vue' | 'euaaaio/unicorn/storybook' | 'euaaaio/unicorn/testing' | 'euaaaio/typescript' | 'euaaaio/vue' | 'euaaaio/prettier' | 'euaaaio/stylistic' | 'euaaaio/perfectionist' | 'euaaaio/oxlint/from-oxlint-config' | 'euaaaio/oxlint/from-oxlint-config-override-0' | 'euaaaio/oxlint/from-oxlint-config-override-1' | 'euaaaio/oxlint/from-oxlint-config-override-2' | 'euaaaio/oxlint/from-oxlint-config-override-3' | 'euaaaio/oxlint/from-oxlint-config-override-4' | 'euaaaio/oxlint/from-oxlint-config-override-5'
