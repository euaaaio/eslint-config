...
export type ConfigNames = 'euaaaio/ignores' | 'euaaaio/ignores/git' | 'euaaaio/javascript' | 'euaaaio/imports' | 'euaaaio/promise' | 'euaaaio/node' | 'euaaaio/de-morgan' | 'euaaaio/unicorn' | 'euaaaio/unicorn/vue' | 'euaaaio/unicorn/astro' | 'euaaaio/unicorn/storybook' | 'euaaaio/unicorn/testing' | 'euaaaio/typescript' | 'euaaaio/typescript/testing' | 'euaaaio/vue' | 'euaaaio/astro' | 'euaaaio/astro/pages' | 'euaaaio/prettier' | 'euaaaio/stylistic' | 'euaaaio/perfectionist' | 'euaaaio/oxlint/from-oxlint-config' | 'euaaaio/oxlint/vue-svelte-exceptions' | 'euaaaio/oxlint/from-oxlint-config-override-0' | 'euaaaio/oxlint/from-oxlint-config-override-1' | 'euaaaio/oxlint/from-oxlint-config-override-2' | 'euaaaio/oxlint/from-oxlint-config-override-3' | 'euaaaio/oxlint/from-oxlint-config-override-4' | 'euaaaio/oxlint/from-oxlint-config-override-5' | 'euaaaio/oxlint/from-oxlint-config-override-6' | 'euaaaio/oxlint/from-oxlint-config-override-7' | 'euaaaio/oxlint/from-oxlint-config-override-8'
